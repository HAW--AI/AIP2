...
public class LieferungModulLogik {

	private final LieferungVerwalter lieferungVerwalter;
	private final TransportauftragVerwalter transportauftragVerwalter;
	
	LieferungModulLogik(LieferungVerwalter lieferungVerwalter, TransportauftragVerwalter transportauftragVerwalter) {
	...
	public boolean bestaetigeLieferung(int lieferungsNummer) {
		...
		Transportauftrag transportauftrag = 
				transportauftragVerwalter.getTransportauftrag(lieferung.getTransportauftrag().getTransportAuftragNr());
	...
	public ILieferung erzeugeLieferung(IAuftrag auftrag) {
		Transportauftrag transportauftrag =
				transportauftragVerwalter.erstelleTransportauftrag(new Date(), "DLH");
