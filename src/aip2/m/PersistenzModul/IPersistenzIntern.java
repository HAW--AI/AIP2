 ...
 * Session zur DB verwaltet.
 * NICHT Threadsafe, da es nur jeweils eine Session gibt!
 * TODO Verursacht HibernateExceptions
 * TODO mehere Sessions für multitreading
 * 
 * 
 */
public interface IPersistenzIntern {
	...
	/**
	 * Sucht in der Tabelle des Types nach Objekten deren Wert in der Spalte columnName value ist
	 * @param type der gesuchte Typ(der KlassenName wird als Tabelle angenommen)
	 * @param columnName
	 * @param value
	 * @return Eine leere Liste falls keine Einträge gefunden wurden, sonst eine volle Liste
	 */
